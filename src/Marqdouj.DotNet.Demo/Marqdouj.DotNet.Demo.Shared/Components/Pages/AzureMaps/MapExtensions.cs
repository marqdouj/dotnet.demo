...
namespace Marqdouj.DotNet.Demo.Shared.Components.Pages.AzureMaps
{
    ...
    internal static class MapExtensions
    {
        ...
        public static string ToMapPageSource(this string name) => HRefRepository.Demo.GitHubSrcFolder($"Marqdouj.DotNet.Demo.Shared.Components.Pages.AzureMaps/{name}.razor");
        public static string ToMapCustomSource(this string name) => HRefRepository.Demo.GitHubSrcFolder($"Marqdouj.DotNet.Demo.CustomMaps/{name}");
